<template>
  <div class="document-editor" @click.alt="debug" @keydown="keydownHandler">
    ...
    <div class="settings">
      <DocumentUserFormSettings :data="editor.template" />
    </div>
...
import DocumentUserFormSettings from "./DocumentUserFormSettings.vue";
...
export default {
  components: {
    DocumentUserFormSettings,
    InstrumentsPanel,
    DocumentTemplate,
    DocumentHeader,
    DocumentRuler,
  },
  name: "DocumentTemplateUserForm",
